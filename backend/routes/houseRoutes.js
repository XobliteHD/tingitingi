...
router.get("/:id", async (req, res) => {
  try {
    ...
    const houseDetails = {
      ...
      presentationContent: house.presentationContent,
      virtualTourVideos: house.virtualTourVideos,
      reviews: house.reviews,
      googlePhotosLink: house.googlePhotosLink,
      displayPhotosUrls: house.displayPhotosUrls,
      image: house.image,
      images: house.images,
